...
import { useDragAndDrop } from '../lib/upload';
...
export default function Account({ isLoggedIn }) {
  ...
  return (
    <div className="relative overflow-hidden z-0" {...getRootProps()}>
      <When condition={isLoaded}>
                ...
                <When condition={!hasUploads}>
                  ...
                  <div className="flex flex-wrap gap-x-10">
                    ...
                    >
                      <div
                        className={clsx(
                          "absolute z-0 top-0 right-0 bottom-0 left-0 transition border-2 transform",
                          isDragActive ? "scale-110 border-w3storage-purple bg-w3storage-red" : "border-w3storage-red bg-w3storage-white"
                        )}
                      />
